  ...
  <body>
		...
		<div class="x-body">
			...
			<span class="x-right" style="line-height:25px">共有数据：
				<span style="color:green;font-weight:600;">${superNumber}</span>
			 条</span>
		<table class="layui-table">
                ...
                <tbody>
                  <c:forEach var="mysuper" items="${superList}" varStatus="status">
                    <tr>
                        <td>${mysuper.superId}</td>
                        <td>${mysuper.superNum}</td>
                        <td>${mysuper.superName}</td>
					</tr>
				 </c:forEach>
                </tbody>
            </table>
