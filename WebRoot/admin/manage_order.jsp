        ...
        <div class="layui-layout layui-layout-admin">
            ...
            <div class="layui-tab layui-tab-card site-demo-title x-main" lay-filter="x-tab" lay-allowclose="true">
			 ...
			 <span class="layui-breadcrumb">
				...
				href="admin_getAllOrder" title="刷新"><i
				class="layui-icon" style="line-height:30px">ဂ</i></a>
		 </div>
		<div class="x-body">
			<form action="admin_getOrderInfo"  class="layui-form x-center" style="width:500px">
			...
			<span class="x-right" style="line-height:25px">共有数据：
				<span style="color:green;font-weight:600;">${orderNumber}</span>
			 条</span>
		<table class="layui-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>${order.remark}</td>
                        <td class="td-manage">
                         <a data-toggle="modal" href="admin_deleteOrder" title="删除操作"><span class="glyphicon glyphicon-trash"></span></a>
                        </td>
					</tr>
				 </c:forEach>
                </tbody>
