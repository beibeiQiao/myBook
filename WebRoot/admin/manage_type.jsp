  ...
  <body>
        <div class="layui-layout layui-layout-admin">
			...
			<span class="layui-breadcrumb">
				...
				href="admin_getAllType" title="刷新"><i
		...
		<div class="x-body">
			...
			<button type="button" data-toggle="modal" data-target="#edit" class="btn btn-primary">增加类型</button>
			<span class="x-right" style="line-height:25px">共有数据：
				<span style="color:green;font-weight:600;">${typeNumber}</span>
			 条</span>
                ...
                <tbody>
                	<c:forEach var="type" items="${typeList}" varStatus="status">
	                    <tr>
							...
							<td>${type.typeName}</td>
	                       <td class="td-manage">
	                         <a data-toggle="modal" href="#edit" title="修改操作"><span class="glyphicon glyphicon-edit"></span></a>
	                         <a data-toggle="modal" href="admin_deleteType" title="删除操作"><span class="glyphicon glyphicon-trash"></span></a>
	                        </td>
						</tr>
				    </c:forEach>
                </tbody>
