...
<div class="row">
    ...
    <div><button type="button" class="btn btn-link"><a href="user_addOrder?book.bookId=6&user.userId=${currUser.userId}"><span class="label label-danger">加入购物车</span></a></button></div>
  </div>
  <hr>
  <div class="row">
